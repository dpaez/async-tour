...
function AboutAsyncDemo (state, emitter) {
    ...
    <main class="">
        ...
        <article class="flex flex-column">
            <h3 class="f2-m f-headline-l fw2 mv3">Bloqueando el event loop</h3>
            <section class="center mt4">
                <div class="pa2">
                    <button onclick=${slowTask} class="f6 link dim ph3 pv2 mb2 mr3 dib white bg-red">
                        SLOW TASK :(
                    </button>

                    <button onclick=${increment} class="f6 link dim ph3 pv2 mb2 mr3 dib white bg-mid-gray">
                        +1
                    </button>
                    <button onclick=${decrement} class="f6 link dim ph3 pv2 mb2 mr3 dib white bg-mid-gray">
                        -1
                    </button>
                </div>
                <div class="">
